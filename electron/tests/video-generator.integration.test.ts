...
describe('video-generator integration (real ffmpeg)', () => {
  ...
  it('produces files compatible with Shorts/Reels/TikTok defaults (1080x1920 <= 60s)', async () => {
    const platforms = [
      ...
      { name: 'InstagramReels', resolution: { width: 1080, height: 1920 }, durationSec: 7 },
  ...
  it('saves output successfully for YouTube, Instagram, TikTok scenarios', async () => {
    const scenarios = [
      { platform: 'YouTube', duration: 10 },
      { platform: 'Instagram', duration: 7 },
